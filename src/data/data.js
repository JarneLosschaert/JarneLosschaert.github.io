export const portfolioData = {
    ...
    experience: [
        ...
        },
        {
            ...
            description: "I participated in a hackathon organized by <span>YPTO</span> in collaboration with <span>Microsoft</span>, held at the VUB campus in Etterbeek. The event brought together tech enthusiasts, developers, and railway experts to brainstorm innovative solutions for the <span>Belgian railway system</span>. My team, <span>Hecate</span>, focused on enhancing operational efficiency by developing an <span>interactive training application</span> for train managers. We used Microsoft's <span>PowerApps</span> platform to create the app, which included features like quizzes and flashcards for interactive learning. After intensive testing and feedback, we presented our project and won the <span>main prize</span> in the Experts track, a 3 day trip to <span>Microsoft's headquarters in Paris</span>."
        },
        {
            id: 2, date: "SEP 2021 - JUN 2024",
            image: "./experiences/howest.jpg",
            description: "I completed my studies at <span>Howest University</span> in Bruges, where I pursued a Bachelor's degree in <span>Applied Computer Science</span>, graduating with <span>distinction</span>. The time I had spent at Howest gave me nearly all the <span>technical skills</span> that I use today, from the programming languages and software development practices. Besides academics, I got to work on <span>various projects</span> and collaborate with different talents, enhancing my problem-solving and teamwork abilities a lot. I also had the chance to make lasting <span>friendships</span> and create wonderful <span>memories</span> throughout my journey."
        },
        {
            id: 1, date: "SEP 2014 - JUN 2021",
