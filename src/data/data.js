export const portfolioData = {
    ...
    profile: "./profile.jpg",
    technologies: [
        { id: 1, name: "HTML5", icon: "technologies/javascript" },
        { id: 2, name: "CSS3", icon: "technologies/javascript" },
        { id: 3, name: "JavaScript", icon: "technologies/javascript" },
        { id: 4, name: "React", icon: "technologies/javascript" },
        { id: 5, name: "Node.js", icon: "technologies/javascript" },
        { id: 6, name: "Express", icon: "technologies/javascript" },
        { id: 7, name: "MongoDB", icon: "technologies/javascript" },
        { id: 8, name: "Git", icon: "technologies/javascript" },
        { id: 8, name: "Git", icon: "technologies/javascript" },
        { id: 8, name: "Git", icon: "technologies/javascript" },
    ],
    projects: [
